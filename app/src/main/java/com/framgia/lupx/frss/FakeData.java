...
public class FakeData {
    ...
    private static List<RSSCategory> getCategories() {
        ...
        lst.add(new RSSCategory("Vietnam", "http://www.telegraph.co.uk/travel/destinations/asia/vietnam/rss", new LatLng(21.017554, 105.784307), R.drawable.vietnam));
        ...
        lst.add(new RSSCategory("South Africa", "http://www.telegraph.co.uk/travel/destinations/africaandindianocean/southafrica/rss", new LatLng(-30.559482, 22.937506), R.drawable.southafrica));
        lst.add(new RSSCategory("Washington DC", "http://www.telegraph.co.uk/travel/destinations/northamerica/usa/washingtondc/rss", new LatLng(38.907192, -77.036871), R.drawable.washington));
        ...
        lst.add(new RSSCategory("Scotland", "http://www.telegraph.co.uk/travel/destinations/europe/uk/scotland/rss", new LatLng(56.490671, -4.202646), R.drawable.scotland));
        ...
        lst.add(new RSSCategory("New Zealand", "http://www.telegraph.co.uk/travel/destinations/australiaandpacific/newzealand/rss", new LatLng(-43.389082, 172.353516), R.drawable.newzealand));
        lst.add(new RSSCategory("Netherlands", "http://www.telegraph.co.uk/travel/destinations/europe/netherlands/rss", new LatLng(52.132633, 5.291266), R.drawable.netherlands));
        lst.add(new RSSCategory("Munich", "http://www.telegraph.co.uk/travel/destinations/europe/germany/munich/rss", new LatLng(48.135125, 11.581981), R.drawable.munich));
